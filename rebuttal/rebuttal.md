...
9. **Scope clarifications.** The attention head is a single learned token-weighting layer; multi-head/additive/gated pooling are future variants. Figure/caption wording is cleaned, and "controlled distribution shift" becomes "mild lexical/style shift."
