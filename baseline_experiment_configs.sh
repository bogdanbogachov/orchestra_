...
add_baseline_experiments "additional_noise_sbert_linear" "sbert_linear" 72 1 10
add_baseline_experiments "additional_noise_distilbert_cls" "distilbert_cls" 72 1 10
